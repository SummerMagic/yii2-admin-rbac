...
return array (
  ...
  array (
    'name' => 'abhi1693/yii2-config',
    'version' => '1.0.0.0',
    'alias' => 
    array (
      '@abhimanyu/config' => $vendorDir . '/abhi1693/yii2-config',
    ),
  ),
  ...
  array (
    'name' => 'gamitg/yii2-detailview4cols',
    'version' => '1.0.0.0',
    'alias' => 
    array (
      '@gamitg/detailview4cols' => $vendorDir . '/gamitg/yii2-detailview4cols',
    ),
  ),
  ...
  array (
    'name' => 'kakadu-dev/yii2-jwt-auth',
    'version' => '2.0.0.0',
    'alias' => 
    array (
      '@Kakadu/Yii2JwtAuth' => $vendorDir . '/kakadu-dev/yii2-jwt-auth/src',
    ),
  ),
);
